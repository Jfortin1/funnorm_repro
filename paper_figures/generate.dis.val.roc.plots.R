...
create.dis.val.roc.plots.kirc <- function(input.dir = "/Users/Jean-Philippe/funnorm_repro", output.dir = "/Users/Jean-Philippe/funnorm_repro/repro_document/figures_repro", 
	print = FALSE, save = TRUE) {
	...
	if (save) {
		...
		printROCFromROCData(rocSVA, xcutoff = 0.1, ycutoff = 0.4, main = "", colors = c("orange", colorsSVA), names = c("ComBat", namesSVA), lty = c(1, 1, 
			1, 1, 2), lwd = c(3, 3, 3, 3, 2))
		dev.off()
		...
		printROCFromROCData(rocRUV, xcutoff = 0.1, ycutoff = 0.4, main = "", colors = c("orange", colorsRUV), names = c("ComBat", namesRUV), lty = c(1, 1, 
	...
	if (print) {
		...
		printROCFromROCData(roc7, xcutoff = 0.1, main = "", ycutoff = 0.4, lwd = rep(2.5, 10), colors = colors7, names = names7, lty = rep(1, 10))
		#printROCFromROCData(roc7, xcutoff = 1, main = "", colors = colors7, lwd = rep(2.5, 10), names = names7, lty = rep(1, 10))
		#printROCFromROCData(rocSVA, xcutoff = 0.1, ycutoff = 0.4, main = "", colors = c("green", colorsSVA), names = c("ComBat", namesSVA), lty = c(1, 1, 
		#	1, 1, 2), lwd = c(3, 3, 3, 3, 2))
		#printROCFromROCData(rocSVA, xcutoff = 1, main = "", colors = c("green", colorsSVA), names = c("ComBat", namesSVA), lty = c(1, 1, 1, 1, 2), lwd = c(3, 
		#	3, 3, 3, 2))
		printROCFromROCData(rocRUV, xcutoff = 0.1, ycutoff = 0.4, main = "", colors = c("orange", colorsRUV), names = c("ComBat", namesRUV), rep(1,10), lwd = c(3, 3, 3, 3, 3, 3, 3))
		#printROCFromROCData(rocRUV, xcutoff = 1, main = "", colors = c("green", colorsRUV), names = c("ComBat", namesRUV), lty = c(1, 1, 1, 1, 2, 1, 2), 
		#	lwd = c(3, 3, 3, 3, 2, 3, 2))
...
create.dis.val.roc.plots.blood <- function(input.dir = "/Users/Jean-Philippe/funnorm_repro", output.dir = "/Users/Jean-Philippe/funnorm_repro/repro_document/figures_repro", 
	print = FALSE, save = TRUE) {
