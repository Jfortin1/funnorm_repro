...
dis.index <- k
val.index <- k+3
data.file.dis <- paste0("combat_dmps_",dataset_names[dis.index],".Rda")
data.file.val <- paste0("combat_dmps_",dataset_names[val.index],".Rda")
...
save(rocData, file=paste0("combat_rocData_",k_vector[k]/1000,"K_",dataset_names[k],".Rda"))
}
